...
// });
// $(function () {
//     $('[data-toggle="calendar"] > .row > .calendar-day').popover({
//         container: 'body',
//         content: 'Hello World',
//         html: true,
//         placement: 'bottom',
...
//     });
//
//     $('[data-toggle="calendar"] > .row > .calendar-day').on('show.bs.popover', function () {
...
$(function () {
    ...
    $('[data-toggle="calendar"] > .row > .calendar-day > .events > .event').on('show.bs.popover', function () {
        ...
        var attending = parseInt($(this).find('div.progress>.progress-bar').attr('aria-valuenow')),
            ...
            displayAttending = attending - $(this).find('div.attending').children().length,
            html = [
                '<form method="post" action="/calendar/save" id="a">',
                '<div class="form-group">',
                    '<label for="exampleFormControlInput1">Zarezerwuj termin</label>',
        '<input class="form-control form-control-sm" name="name" type="text" placeholder="imię">',
            '<input class="form-control form-control-sm" name="surname" type="text" placeholder="nazwisko">',
            '<input type="email" class="form-control" name="email" id="exampleFormControlInput1" placeholder="mail">',
            '<input class="form-control form-control-sm" name="tel" type="text" placeholder="numer telefonu">',
                '<input type="hidden" name="divId" value=',parentTag,'>',
